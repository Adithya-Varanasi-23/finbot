...
monthly_income = st.sidebar.number_input("Est. Monthly Income ($)", min_value=0, value=0, step=500)
monthly_expenses = st.sidebar.number_input("Est. Monthly Expenses ($)", min_value=0, value=0, step=100)
...
if monthly_income == 0 and monthly_expenses == 0:
    st.info("👈 Please enter your estimated monthly income and expenses in the sidebar to generate your financial health analysis.")
else:
    # Charts
